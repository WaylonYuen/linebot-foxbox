...
# ImagemapSendMessage(組圖訊息) 最新合作廠商
...
# TemplateSendMessage - ButtonsTemplate(按鈕介面訊息) 最新活動
def buttons_message():
...
# TemplateSendMessage - ConfirmTemplate(確認介面訊息) 註冊會員
...
# 側向滑動輪播清單,提供圖片&選擇連結
# TemplateSendMessage - CarouselTemplate(輪播介面訊息) 旋轉木馬
...
# 側向滑動輪播清單,提供圖片連結
# TemplateSendMessage - ImageCarouselTemplate(圖片輪播介面訊息) 圖片畫廊
def Image_CarouselTemplate():
    message = TemplateSendMessage(
        alt_text='圖片旋轉木馬',
